...
import { Search, ChevronDown, BookOpen, Code, BarChart, Layout, User } from 'lucide-react';
    ...
    <div className="grid grid-cols-3 gap-8">
      ...
      <div className="rounded-xl bg-[#ff4628] p-4 text-white shadow-md">
        ...
        <div className="flex items-center gap-4">
          {userData ? (
            <Link to="/profile" className="flex items-center gap-3 pl-4 border-l border-gray-100 group">
