...
const partnerLogos = [
  ...
  { 
    ...
    logo: 'https://upload.wikimedia.org/wikipedia/en/a/af/University_of_Illinois_at_Urbana%E2%80%93Champaign_logo.svg',
    isIcon: false 
  },
  { 
    name: 'OpenAI', 
  ...
  { 
    ...
    logo: 'https://upload.wikimedia.org/wikipedia/commons/1/12/DeepLearning.AI_logo.png', 
    isIcon: true 
  },
  { 
  ...
  { 
    ...
    logo: 'https://upload.wikimedia.org/wikipedia/commons/9/92/UPenn_shield_logo.svg', 
    isIcon: false 
  },
  { 
    name: 'University of Michigan', 
    logo: 'https://upload.wikimedia.org/wikipedia/commons/d/d4/University_of_Michigan_Logo.svg', 
    isIcon: false 
  },
];
      ...
      <div className="mx-auto px-2 sm:px-2 lg:px-8" style={{ maxWidth: '1280px' }}>
        <div className="flex items-end justify-between mb-5">
          ...
          <div className="flex items-center gap-2 shrink-0 ml-4">
            ...
            <Link to={seeAllHref} className="text-sm font-semibold text-[#0056d2] hover:underline hidden sm:inline ml-1">See all</Link>
          </div>
        </div>
...
function HeroBanners() {
  return (
    <div className="w-full bg-white py-12 px-6">
      <div className="max-w-[1400px] mx-auto min-h-[800px] relative overflow-hidden rounded-[1rem] lg:rounded-[3rem]">
        
        {/* Full Background Image - Clean */}
        ...
        <div className="relative z-20 flex flex-col lg:flex-row h-full min-h-[800px]">
          
          {/* Left Section */}
          <div className="w-full lg:w-3/5 p-8 md:p-20 flex flex-col justify-center">
            <div className="mb-12">
              
              
              <h1 className="text-6xl md:text-[7.5rem] font-black text-white leading-[0.85] tracking-tighter uppercase mb-8">
                Future <br />
                <span className="text-orange-500 italic font-serif lowercase tracking-normal">is</span> <br />
                Expert.
              </h1>

              <p className="text-gray-200 text-lg max-w-sm leading-tight mb-12 uppercase tracking-tighter border-l-2 border-orange-500 pl-6">
                High-performance mentorship for the next generation of industry leaders.
              </p>

              <div className="flex flex-wrap gap-4 pt-4">
                <button className="px-12 py-6 bg-orange-500 text-white font-bold text-xs uppercase tracking-widest hover:bg-white hover:text-black transition-all duration-300">
                  Get Started
                </button>
                <button className="px-12 py-6 bg-white/10 text-white border border-white/20 font-bold text-xs uppercase tracking-widest hover:bg-orange-500 hover:border-orange-500 transition-all duration-300">
                  The Program
                </button>
              </div>
            </div>
          ...
          {/* Right Section */}
          <div className="w-full lg:w-2/5 relative flex items-center justify-center lg:justify-end lg:pr-20 pb-20 lg:pb-0">
            <div className="h-[400px] w-64 overflow-hidden relative">
              
              <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-transparent to-transparent z-30" />
              
              <div className="flex flex-col gap-6 animate-[verticalScroll_18s_linear_infinite] hover:[animation-play-state:paused]">
                {[
                  { label: "Placement", val: "94%" },
                  ...
                  <div 
                    key={idx} 
                    className="border border-white/10 p-8 hover:border-orange-500 transition-colors group"
                  >
                    <div className="text-5xl font-black text-white group-hover:text-orange-500 transition-colors">{item.val}</div>
                    <div className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em] mt-2">
                      {item.label}
                    </div>
                  </div>
                ))}
        ...
        {/* Bottom Ticker */}
        <div className="absolute bottom-0 left-0 w-full bg-white py-4 overflow-hidden whitespace-nowrap z-30">
          <div className="inline-block animate-[horizontalScroll_30s_linear_infinite] text-black font-black text-[11px] uppercase tracking-[0.6em]">
            UPGRADE YOUR SKILLSET • 50K+ STUDENTS ENROLLED • DIRECT MENTORSHIP • GLOBAL CERTIFICATION • UPGRADE YOUR SKILLSET • 50K+ STUDENTS ENROLLED • DIRECT MENTORSHIP • GLOBAL CERTIFICATION •
          </div>
        </div>
      </div>
...
export default function Landings() {
  return (
    <div className="flex flex-col w-full bg-white">
      ...
      <ScrollSection title="Trending courses" seeAllHref="/courses">
        {trendingCourses.map(c => <CourseCard key={c.id} c={c} />)}
      </ScrollSection>
 <HeroBanners />
      <ScrollSection
        title="Earn a degree"
        subtitle="Achieve your goals with an accredited online degree"
        seeAllHref="/degrees"
      >
        {degrees.map(d => <DegreeCard key={d.title} d={d} />)}
      </ScrollSection>
