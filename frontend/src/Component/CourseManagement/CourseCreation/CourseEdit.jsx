...
const CourseEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (file) {
        formData.append('coverImage', file); // Add file if user selected a new one
      }
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-[640px] space-y-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {form.coverImage && <img src={form.coverImage} alt="cover" className="w-32 h-20 object-cover rounded border" />}
